...
pub fn assembly_table() -> &'static Table {
	assembly_table_storage.get_or_init(|| {
		...
		table.insert(
			Mnemonic::Mov,
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::XRegister,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::YRegister,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::IndirectX,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::ARegister,
						(0xC6, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::IndirectXAutoIncrement,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::ARegister,
						(0xAF, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::Address,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::XIndexed,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::ARegister,
						(0xD5, append_first_as_16_bits as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::YIndexed,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::ARegister,
						(0xD6, append_first_as_16_bits as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPageYIndexed,
					EntryOrSecondOperandTable::from([
				...
				(
					AddressingModeCategory::DirectPageXIndexedIndirect,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::ARegister,
						(0xC7, append_first_as_8_bits as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPageIndirectYIndexed,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::ARegister,
						(0xD7, append_first_as_8_bits as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::StackPointerRegister,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::XRegister,
						(0xBD, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
			]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				...
				(
					AddressingModeCategory::IndirectX,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::IndirectY,
						(0x99, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				...
				(
					...
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::IndirectY,
						(0xB9, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				...
				(
					...
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::IndirectY,
						(0x79, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				...
				(
					...
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::IndirectY,
						(0x39, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				...
				(
					...
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::IndirectY,
						(0x19, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				...
				(
					...
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::IndirectY,
						(0x59, two_operand_nop as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0xBC, one_operand_nop as SingleOperandSegmentAction),
				),
				(AddressingModeCategory::DirectPage, EntryOrSecondOperandTable::Entry(0xAB, append_one_as_8_bits)),
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::Entry(0xBB, append_one_as_8_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0x9C, one_operand_nop as SingleOperandSegmentAction),
				),
				(AddressingModeCategory::DirectPage, EntryOrSecondOperandTable::Entry(0x8B, append_one_as_8_bits)),
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::Entry(0x9B, append_one_as_8_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0x1C, one_operand_nop as SingleOperandSegmentAction),
				),
				(AddressingModeCategory::DirectPage, EntryOrSecondOperandTable::Entry(0x0B, append_one_as_8_bits)),
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::Entry(0x1B, append_one_as_8_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0x5C, one_operand_nop as SingleOperandSegmentAction),
				),
				(AddressingModeCategory::DirectPage, EntryOrSecondOperandTable::Entry(0x4B, append_one_as_8_bits)),
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::Entry(0x5B, append_one_as_8_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0x3C, one_operand_nop as SingleOperandSegmentAction),
				),
				(AddressingModeCategory::DirectPage, EntryOrSecondOperandTable::Entry(0x2B, append_one_as_8_bits)),
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::Entry(0x3B, append_one_as_8_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0x7C, one_operand_nop as SingleOperandSegmentAction),
				),
				(AddressingModeCategory::DirectPage, EntryOrSecondOperandTable::Entry(0x6B, append_one_as_8_bits)),
				(
					AddressingModeCategory::DirectPageXIndexed,
					EntryOrSecondOperandTable::Entry(0x7B, append_one_as_8_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::ARegister,
				EntryOrSecondOperandTable::Entry(0x9F, one_operand_nop as SingleOperandSegmentAction),
			)]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::YARegister,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::DirectPage,
						(0xBA, append_second_as_8_bits as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::YARegister,
						(0xDA, append_first_as_8_bits as TwoOperandSegmentAction),
					)]),
				),
			]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::DirectPage,
				EntryOrSecondOperandTable::Entry(0x3A, append_one_as_8_bits as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Decw,
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::DirectPage,
				EntryOrSecondOperandTable::Entry(0x1A, append_one_as_8_bits as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Addw,
			EntryOrFirstOperandTable::from([(
				...
				EntryOrSecondOperandTable::from([(
					AddressingModeCategory::DirectPage,
					(0x7A, append_second_as_8_bits as TwoOperandSegmentAction),
				)]),
			)]),
		);
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				...
				EntryOrSecondOperandTable::from([(
					AddressingModeCategory::DirectPage,
					(0x9A, append_second_as_8_bits as TwoOperandSegmentAction),
				)]),
			)]),
		);
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				...
				EntryOrSecondOperandTable::from([(
					AddressingModeCategory::DirectPage,
					(0x5A, append_second_as_8_bits as TwoOperandSegmentAction),
				)]),
			)]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::YARegister,
				EntryOrSecondOperandTable::Entry(0xCF, one_operand_nop as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Div,
			EntryOrFirstOperandTable::from([(
				...
				EntryOrSecondOperandTable::from([(
					AddressingModeCategory::XRegister,
					(0x9E, two_operand_nop as TwoOperandSegmentAction),
				)]),
			)]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::ARegister,
				EntryOrSecondOperandTable::Entry(0xDF, one_operand_nop as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Das,
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::ARegister,
				EntryOrSecondOperandTable::Entry(0xBE, one_operand_nop as SingleOperandSegmentAction),
			)]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x2F, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0xF0, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0xD0, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0xB0, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x90, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x70, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x50, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x30, append_one_relative as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x10, append_one_relative as SingleOperandSegmentAction),
				),
		...
		let bbs_entry = EntryOrFirstOperandTable::from([
			(
				AddressingModeCategory::DirectPageBit,
				EntryOrSecondOperandTable::from([
					(
						AddressingModeCategory::DirectPage,
						TwoOperandEntry::BitEntry(
							0x03,
							append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction,
						),
					),
					(
						AddressingModeCategory::Address,
						TwoOperandEntry::BitEntry(0x03, append_both_reversed_as_8_bits_and_second_relative),
					),
				]),
			),
			(
		...
		let bbc_entry = EntryOrFirstOperandTable::from([
			(
				...
				EntryOrSecondOperandTable::from([
					...
					(
						AddressingModeCategory::Address,
						TwoOperandEntry::BitEntry(0x13, append_both_reversed_as_8_bits_and_second_relative),
					),
				]),
			),
			(
			...
			EntryOrFirstOperandTable::from([
				(
					...
					EntryOrSecondOperandTable::from([
						(
							AddressingModeCategory::DirectPage,
							(0x2E, append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction),
						),
						(
							AddressingModeCategory::Address,
							(0x2E, append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction),
				...
				(
					...
					EntryOrSecondOperandTable::from([
						(
							AddressingModeCategory::DirectPage,
							(0xDE, append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction),
						),
						(
							AddressingModeCategory::Address,
							(0xDE, append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction),
			...
			EntryOrFirstOperandTable::from([
				(
					...
					EntryOrSecondOperandTable::from([
						(
							AddressingModeCategory::DirectPage,
							(0x6E, append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction),
						),
						(
							AddressingModeCategory::Address,
							(0x6E, append_both_reversed_as_8_bits_and_second_relative as TwoOperandSegmentAction),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::Address,
					EntryOrSecondOperandTable::Entry(0x5F, append_one_as_16_bits as SingleOperandSegmentAction),
				),
				(
					AddressingModeCategory::DirectPage,
					EntryOrSecondOperandTable::Entry(0x5F, append_one_as_16_bits as SingleOperandSegmentAction),
				...
				(
					AddressingModeCategory::DirectPageXIndexedIndirect,
					EntryOrSecondOperandTable::Entry(0x1F, append_one_as_16_bits),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::Address,
				EntryOrSecondOperandTable::Entry(0x3F, append_one_as_16_bits as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Pcall,
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::DirectPage,
				EntryOrSecondOperandTable::Entry(0x4F, append_one_as_8_bits as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Tcall,
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::DirectPage,
				EntryOrSecondOperandTable::TcallEntry(0x01),
			)]),
		);
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0x2D, one_operand_nop as SingleOperandSegmentAction),
				),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([
				(
					AddressingModeCategory::ARegister,
					EntryOrSecondOperandTable::Entry(0xAE, one_operand_nop as SingleOperandSegmentAction),
				),
		...
		let set_entry = EntryOrFirstOperandTable::from([
			(
				AddressingModeCategory::DirectPageBit,
				EntryOrSecondOperandTable::BitEntry(0x02, append_one_as_8_bits as SingleOperandSegmentAction),
			),
			(
				AddressingModeCategory::DirectPage,
				EntryOrSecondOperandTable::BitEntry(0x02, append_one_as_8_bits as SingleOperandSegmentAction),
		...
		let clr_entry = EntryOrFirstOperandTable::from([
			(
				AddressingModeCategory::DirectPageBit,
				EntryOrSecondOperandTable::BitEntry(0x12, append_one_as_8_bits as SingleOperandSegmentAction),
			),
			(
				AddressingModeCategory::DirectPage,
				EntryOrSecondOperandTable::BitEntry(0x12, append_one_as_8_bits as SingleOperandSegmentAction),
		...
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::Address,
				EntryOrSecondOperandTable::ImplicitAEntry(0x0E, append_one_as_16_bits as SingleOperandSegmentAction),
			)]),
		);
		table.insert(
			Mnemonic::Tclr1,
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::Address,
				EntryOrSecondOperandTable::ImplicitAEntry(0x4E, append_one_as_16_bits as SingleOperandSegmentAction),
			)]),
		);
		...
		table.insert(
			Mnemonic::And1,
			EntryOrFirstOperandTable::from([(
				AddressingModeCategory::CarryFlag,
				EntryOrSecondOperandTable::from([
					(
						AddressingModeCategory::AddressBit,
						TwoOperandEntry::Entry(0x4A, append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction),
					),
					(
						AddressingModeCategory::Address,
						TwoOperandEntry::Entry(0x4A, append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction),
					...
					(
						AddressingModeCategory::NegatedAddressBit,
						TwoOperandEntry::Entry(0x6A, append_second_as_16_bits_and_bit_index),
					),
				]),
			)]),
		);
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				...
				EntryOrSecondOperandTable::from([
					(
						AddressingModeCategory::AddressBit,
						TwoOperandEntry::Entry(0x0A, append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction),
					),
					(
						AddressingModeCategory::Address,
						TwoOperandEntry::Entry(0x0A, append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction),
					...
					(
						AddressingModeCategory::NegatedAddressBit,
						TwoOperandEntry::Entry(0x2A, append_second_as_16_bits_and_bit_index),
					),
				]),
			)]),
		);
		table.insert(
			...
			EntryOrFirstOperandTable::from([(
				...
				EntryOrSecondOperandTable::from([
					(
						AddressingModeCategory::AddressBit,
						TwoOperandEntry::Entry(0x8A, append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction),
					),
					(
						AddressingModeCategory::Address,
						TwoOperandEntry::Entry(0x8A, append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction),
			...
			EntryOrFirstOperandTable::from([
				(
					...
					EntryOrSecondOperandTable::Entry(
						0xEA,
						append_one_as_16_bits_and_bit_index as SingleOperandSegmentAction,
					),
				),
				(
					AddressingModeCategory::Address,
			...
			EntryOrFirstOperandTable::from([
				(
					...
					EntryOrSecondOperandTable::from([
						(
							AddressingModeCategory::AddressBit,
							TwoOperandEntry::Entry(
								0xAA,
								append_second_as_16_bits_and_bit_index as TwoOperandSegmentAction,
							),
						),
						(
							AddressingModeCategory::Address,
				...
				(
					...
					EntryOrSecondOperandTable::from([(
						AddressingModeCategory::CarryFlag,
						TwoOperandEntry::Entry(0xCA, append_first_as_16_bits_and_bit_index as TwoOperandSegmentAction),
					)]),
				),
				(
					AddressingModeCategory::Address,
...
fn append_one_as_8_bits(
	...
	data.append_8_bits_unresolved(first.clone(), 0, true, &Vec::default(), span)
}
...
fn append_one_as_16_bits_and_bit_index(
	...
	data.append_8_bits_unresolved(first.clone(), 0, false, &Vec::default(), span)?;
...
fn append_second_as_8_bits(
	...
	data.append_8_bits_unresolved(second.clone(), 0, true, &Vec::default(), span)
}
...
fn append_second_as_16_bits_and_bit_index(
	...
	data.append_8_bits_unresolved(second.clone(), 0, false, &Vec::default(), span)?;
